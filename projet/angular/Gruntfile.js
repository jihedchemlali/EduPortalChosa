module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        curl: {
            installWiremock: {
                ...
                dest: 'dist/front/wiremock/wiremock-standalone-2.1.10.jar'
            }
        },
        exec: {
            liteserver: {
    ...
    grunt.registerTask('mock', 'Start stubs', function(target) {
        var wiremockProcess = grunt.util.spawn({
            cmd: 'java',
            args: [
                '-jar', 'dist/front/wiremock/wiremock-standalone-2.1.10.jar',
                '--port', app.stubPort,
                '--root-dir', '/home/ammar/DATA/workspace/chosa-v2/projet/angular/src/test',
                '--verbose'
            ]
        });
        // console logger
